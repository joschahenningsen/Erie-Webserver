 ...
 * Server.Terminal zur Verf&uuml;gung.
 * 
 */
public final class Terminal {
  ...
  private static InputStream inIs = null;
  private static BufferedReader inBr = null;

  private static BufferedReader in() {
    if(System.in != inIs) {
      inIs = System.in;
      inBr = new BufferedReader(new InputStreamReader(inIs));
    }
    return inBr;
  }
  ...
  /**
   * Liest eine Zeichenkette vom Server.Terminal.
   * 
  ...
  /**
   * Liest einen Wahrheitswert vom Server.Terminal. Die Zeichenkette "true"
  ...
  /**
   * Liest ein Zeichen vom Server.Terminal. Zeilenumbruche zaehlen als eigene Zeichen.
   * 
  ...
  /**
   * Liest eine ganze Zahl (8 Bit) vom Server.Terminal.
   * 
  ...
  /**
   * Liest eine ganze Zahl (16 Bit) vom Server.Terminal.
   * 
   * @return die gelesene Zahl.
   */
  ...
  /**
   * Liest eine ganze Zahl (32 Bit) vom Server.Terminal.
   * 
   * @return die gelesene Zahl.
   */
  ...
  /**
   * Liest eine ganze Zahl (64 Bit) vom Server.Terminal.
   * 
   * @return die gelesene Zahl.
   */
  ...
  /**
   * Liest eine Gleitpunktzahl(32 Bit) vom Server.Terminal.
   * 
   * @return die gelesene Zahl.
   */
  ...
  /**
   * Liest eine Gleitpunktzahl(64 Bit) vom Server.Terminal.
   * 
   * @return die gelesene Zahl.
   */
  ...
  /**
   * Liest ein Integer-Array vom Server.Terminal.
   * 
  ...
  /**
   * Liest eine Integer-Matrix vom Server.Terminal.
   * 
